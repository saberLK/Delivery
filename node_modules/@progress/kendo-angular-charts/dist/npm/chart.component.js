...
var ChartComponent = /** @class */ (function (_super) {
    ...
    ChartComponent.prototype.ngAfterViewInit = function () {
        ...
        this.subscriptions = this.intl.changes.subscribe(this.intlChange.bind(this))
            .add(this.localizationService.changes.subscribe(this.rtlChange.bind(this)));
    };
    ...
    ChartComponent.prototype.refreshWait = function () {
        var _this = this;
        this.ngZone.runOutsideAngular(function () {
            _this.subscription = combineLatest_1.combineLatest(_this.configurationService.onChange$, _this.themeService.onChange$, function (options, theme) {
                _this.options = options;
                _this.theme = theme;
            }).pipe(auditTime_1.auditTime(configuration_service_1.THROTTLE_MS))
                .subscribe(function () {
                _this.refresh();
            });
        });
    ...
    ChartComponent.propDecorators = {
        ...
        'resizeRateLimit': [{ type: core_4.Input },],
        'seriesComponents': [{ type: core_2.ContentChildren, args: [series_item_component_1.SeriesItemComponent, { descendants: true },] },],
        'donutCenterTemplate': [{ type: core_1.ContentChild, args: [donut_center_template_directive_1.DonutCenterTemplateDirective,] },],
        ...
        'surfaceElement': [{ type: core_2.ViewChild, args: ['surface',] },],
    };
